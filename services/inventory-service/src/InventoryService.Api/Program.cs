...
builder.Services.AddSwaggerGen(options =>
{
    options.SwaggerDoc("v1", new OpenApiInfo
    {
        ...
        Version = "v1",
        Description = "Microservice responsible for warehouse inventory management — stock levels, restocking, reservations, and low-stock alerts. Extracted from the OrderManager monolith.",
